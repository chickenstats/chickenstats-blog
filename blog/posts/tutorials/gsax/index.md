...
Use the `chickenstats` library to scrape play-by-play data and analyze
...
Filter the dataframes for goalies and add goals saved above expected
stats
...
Cumulative time-on-ice and goals saved above expected for top-6 goalies
in NHL
...
Getting game winners and calculating time between games with the
schedule object
